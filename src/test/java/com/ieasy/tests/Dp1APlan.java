...
public class Dp1APlan extends TestBase {
	
	private static final Logger log = LogManager.getLogger(Dp1APlan.class);
	...
	public Object[][] healthDataProvider() throws Exception {
		...
		ArrayList<HealthPOJO> healthDataList = testData(xlFilePath, "Dp1APlan");
